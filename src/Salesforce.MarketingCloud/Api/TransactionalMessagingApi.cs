...
namespace Salesforce.MarketingCloud.Api
{
    ...
    public partial class TransactionalMessagingApi : ITransactionalMessagingApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        internal TransactionalMessagingApi(String authBasePath, string clientId, string clientSecret, string accountId, string scope)
        {
        ...
        /// <returns></returns>
        internal TransactionalMessagingApi(Salesforce.MarketingCloud.Client.Configuration configuration = null)
        {
