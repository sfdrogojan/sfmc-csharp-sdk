...
namespace Salesforce.MarketingCloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseGetEmailDefinitions :  IEquatable<ResponseGetEmailDefinitions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseGetEmailDefinitions" /> class.
        /// </summary>
        ...
        public ResponseGetEmailDefinitions(string requestId = default(string), List<RequestCreateEmailDefinition> definitions = default(List<RequestCreateEmailDefinition>), int? count = default(int?), int? page = default(int?), int? pageSize = default(int?))
        {
        ...
        public List<RequestCreateEmailDefinition> Definitions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseGetEmailDefinitions {\n");
        ...
        {
            return this.Equals(input as ResponseGetEmailDefinitions);
        }

        /// <summary>
        /// Returns true if ResponseGetEmailDefinitions instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseGetEmailDefinitions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseGetEmailDefinitions input)
        {
            if (input == null)
                return false;
