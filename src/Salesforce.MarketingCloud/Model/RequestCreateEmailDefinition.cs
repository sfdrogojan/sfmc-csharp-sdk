...
namespace Salesforce.MarketingCloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RequestCreateEmailDefinition :  IEquatable<RequestCreateEmailDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestCreateEmailDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RequestCreateEmailDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestCreateEmailDefinition" /> class.
        /// </summary>
        ...
        public RequestCreateEmailDefinition(string name = default(string), string definitionKey = default(string), string definitionId = default(string), string description = default(string), string classification = default(string), string status = default(string), RequestCreateEmailDefinitionContent content = default(RequestCreateEmailDefinitionContent), RequestCreateEmailDefinitionSubscriptions subscriptions = default(RequestCreateEmailDefinitionSubscriptions), RequestCreateEmailDefinitionOptions options = default(RequestCreateEmailDefinitionOptions))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for RequestCreateEmailDefinition and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("definitionKey is a required property for RequestCreateEmailDefinition and cannot be null");
            }
            else
            {
            ...
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for RequestCreateEmailDefinition and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("subscriptions is a required property for RequestCreateEmailDefinition and cannot be null");
            }
            else
            {
        ...
        public RequestCreateEmailDefinitionContent Content { get; set; }

        /// <summary>
        /// Gets or Sets Subscriptions
        /// </summary>
        [DataMember(Name="subscriptions", EmitDefaultValue=false)]
        public RequestCreateEmailDefinitionSubscriptions Subscriptions { get; set; }

        /// <summary>
        /// Gets or Sets Options
        /// </summary>
        [DataMember(Name="options", EmitDefaultValue=false)]
        public RequestCreateEmailDefinitionOptions Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestCreateEmailDefinition {\n");
        ...
        {
            return this.Equals(input as RequestCreateEmailDefinition);
        }

        /// <summary>
        /// Returns true if RequestCreateEmailDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestCreateEmailDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestCreateEmailDefinition input)
        {
            if (input == null)
                return false;
